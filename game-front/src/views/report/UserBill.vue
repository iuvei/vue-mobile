<template>
  <section style="width: 100%">
    ...
    <el-col :span="24" class="toolbar">
      <el-form :inline="true">
        <el-form-item label="商户账号">
          <el-cascader :options="options" change-on-select :clearable="clearable" :show-all-levels="false"></el-cascader>
        </el-form-item>
    ...
    <!--列表-->
    <el-table :data="lists" border v-loading="listLoading" style="width: 100%;" size="mini">
...
import {getCurrentMonth} from '../../assets/js/date'
...
export default {
  data() {
    return {
      ...
      time1: [getCurrentMonth.begin,getCurrentMonth.end ],
      //编辑界面数据
      editForm: {},
