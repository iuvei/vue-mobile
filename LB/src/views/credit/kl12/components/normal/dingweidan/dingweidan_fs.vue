      ...
      numberList: [
        {
          ...
          ylList: [5, 5, 17, 11, 14, 13, 0, 2, 20, 6, 22, 22],
          lrList: [14, 11, 10, 16, 18, 9, 10, 14, 5, 15, 32, 22]
        },
        {
          type: '第二位',
          isSelectAll: false,
        ...
        },
        {
          ...
          ylList: [5, 5, 17, 11, 14, 13, 0, 2, 20, 6, 22, 22],
          lrList: [14, 11, 10, 16, 18, 9, 10, 14, 5, 15, 22, 32]
        },
        {
          type: '第五位',
          isSelectAll: false,
          ...
          ylList: [5, 5, 17, 11, 14, 13, 22, 0, 2, 20, 6, 22],
          lrList: [14, 11, 10, 16, 18, 9, 10, 22, 14, 5, 15, 32]
        }
      ],
  ...
  watch: {
    flagCount () {
      ...
      this.numberList.map(item => {
        ...
        if (innerList.length) numberList.push(innerList)
      })
