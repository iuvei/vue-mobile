...
export default {
      ...
      numberList: [
        {
          ...
          ylList: [5, 5, 17, 11, 14, 13, 0, 2, 20, 6, 22, 28],
          lrList: [14, 11, 10, 16, 18, 9, 10, 14, 5, 15, 32, 69]
        },
        {
          type: '拖码',
          showMenu: true,
          ...
          ylList: [5, 5, 17, 11, 14, 13, 0, 2, 20, 6, 22, 28],
          lrList: [14, 11, 10, 16, 18, 9, 10, 14, 5, 15, 25, 32]
        }
      ],
  ...
  methods: {
    ...
    calculateBetCounts (type, ball, index) {
      ...
      if (danMaList.length === 1) count = tuoMaList.length
