      ...
      numberList: [
        {
          ...
          ylList: [5, 5, 17, 11, 14, 13, 0, 22, 2, 20, 6, 22],
          lrList: [14, 11, 10, 16, 18, 9, 10, 14, 5, 22, 15, 32]
        },
        {
          type: '第二位',
          isSelectAll: false,
          ...
          ylList: [5, 5, 17, 11, 22, 14, 13, 0, 2, 20, 6, 22],
          lrList: [14, 11, 22, 10, 16, 18, 9, 10, 14, 5, 15, 32]
        },
        {
          type: '第三位',
          isSelectAll: false,
          ...
          ylList: [5, 5, 17, 11, 14, 22, 13, 0, 2, 20, 6, 22],
          lrList: [14, 11, 22, 10, 16, 18, 9, 10, 14, 5, 15, 32]
        }
      ],
    ...
    calculateBetCounts () {
      ...
      this.numberList.map(item => {
        ...
        item.numberList.map(itemInner => {
          if (itemInner.isSelected) innerArr.push(itemInner.value)
        })
        if (innerArr.length) {
      ...
      if (countArr.length < 3) {
        ...
        for (let i = 0; i < countArr[0].length; i++) {
          for (let j = 0; j < countArr[1].length; j++) {
            if (countArr[0][i] === countArr[1][j]) continue
            for (let k = 0; k < countArr[2].length; k++) {
              if (countArr[2][k] === countArr[1][j] || countArr[2][k] === countArr[0][i]) continue
              count++
            }
          }
        }
