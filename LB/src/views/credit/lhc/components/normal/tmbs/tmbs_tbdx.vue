      ...
      numberList: [
        {
          ...
          isSelectEven: false,
          numberList: [
            { isSelected: false, value: 0, label: '红单' },
            { isSelected: false, value: 1, label: '红双' },
            { isSelected: false, value: 2, label: '蓝单' },
            { isSelected: false, value: 2, label: '蓝双' },
            { isSelected: false, value: 2, label: '绿单' },
            { isSelected: false, value: 2, label: '绿双' }
          ]
        }
      ],
