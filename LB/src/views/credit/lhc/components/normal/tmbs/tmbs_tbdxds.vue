      ...
      numberList: [
        {
          ...
          isSelectEven: false,
          numberList: [
            { isSelected: false, value: 0, label: '红大单' },
            { isSelected: false, value: 1, label: '红小单' },
            { isSelected: false, value: 2, label: '蓝大单' },
            { isSelected: false, value: 2, label: '蓝小单' },
            { isSelected: false, value: 2, label: '绿大单' },
            { isSelected: false, value: 2, label: '绿小单' },
            { isSelected: false, value: 0, label: '红大双' },
            { isSelected: false, value: 1, label: '红小双' },
            { isSelected: false, value: 2, label: '蓝大双' },
            { isSelected: false, value: 2, label: '蓝小双' },
            { isSelected: false, value: 2, label: '绿大双' },
            { isSelected: false, value: 2, label: '绿小双' }
          ]
        }
      ],
...
<style scoped>
  ...
  .choice-number-list > li .top > .balls {
    width: 600px;
  }
</style>
