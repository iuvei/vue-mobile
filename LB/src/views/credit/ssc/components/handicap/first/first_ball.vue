      ...
      numberList: [
        {
          ...
          numberList: [
            ...
            { label: '大', value: 0, upperLabel: 'first', labelMap: 'daxiaozuhe', odd: 0, betCount: '', maxCount: 0, wayId: '', price: '', prize: '', coefficient: handicapAjaxValueConfig.coefficientEven, maxOdd: 0 },
            { label: '小', value: 1, upperLabel: 'first', labelMap: 'daxiaozuhe', odd: 0, betCount: '', maxCount: 0, wayId: '', price: '', prize: '', coefficient: handicapAjaxValueConfig.coefficientEven, maxOdd: 0 },
            { label: '单', value: 2, upperLabel: 'first', labelMap: 'danshuangzuhe', odd: 0, betCount: '', maxCount: 0, wayId: '', price: '', prize: '', coefficient: handicapAjaxValueConfig.coefficientEven, maxOdd: 0 },
            { label: '双', value: 3, upperLabel: 'first', labelMap: 'danshuangzuhe', odd: 0, betCount: '', maxCount: 0, wayId: '', price: '', prize: '', coefficient: handicapAjaxValueConfig.coefficientEven, maxOdd: 0 }
          ]
        },
        {
          type: '总和-龙虎和',
