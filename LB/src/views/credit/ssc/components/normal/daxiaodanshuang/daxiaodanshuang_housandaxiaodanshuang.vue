  ...
  methods: {
    ...
    calculateBetCounts () {
      ...
      this.numberList[0].numberList.map(item => {
        if (item.isSelected) hundredNumber.push(item)
      })
      this.numberList[1].numberList.map(item => {
        if (item.isSelected) tenNumber.push(item)
      })
      this.numberList[2].numberList.map(item => {
        if (item.isSelected) sinNumber.push(item)
      })
      count = tenNumber.length * sinNumber.length * hundredNumber.length
