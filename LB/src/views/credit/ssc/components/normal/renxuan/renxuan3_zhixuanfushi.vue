    ...
    calculateBetCounts () {
      ...
      if (countArr.length >= 3) {
        countArr.map((item, index) => {
          let remainCount = 0
          countArr.map((itemInner, indexInner) => {
            if (indexInner <= index) return
            remainCount += itemInner.length
          })
          count += remainCount * item.length
        })
      } */
      let countArr = []
      let count = 0
      ...
      if (countArr.length === 3) {
        count = countArr[0].length * countArr[1].length * countArr[2].length
      }
      if (countArr.length === 4) {
        count += countArr[0].length * countArr[1].length * countArr[2].length
        count += countArr[0].length * countArr[1].length * countArr[3].length
        count += countArr[0].length * countArr[2].length * countArr[3].length
        count += countArr[1].length * countArr[2].length * countArr[3].length
      }
      if (countArr.length === 5) {
        count += countArr[0].length * countArr[1].length * countArr[2].length
        count += countArr[0].length * countArr[1].length * countArr[3].length
        count += countArr[1].length * countArr[2].length * countArr[3].length
        count += countArr[0].length * countArr[1].length * countArr[4].length
        count += countArr[0].length * countArr[2].length * countArr[4].length
        count += countArr[0].length * countArr[2].length * countArr[3].length
        count += countArr[0].length * countArr[3].length * countArr[4].length
        count += countArr[1].length * countArr[2].length * countArr[4].length
        count += countArr[1].length * countArr[3].length * countArr[4].length
        count += countArr[2].length * countArr[3].length * countArr[4].length
      }
