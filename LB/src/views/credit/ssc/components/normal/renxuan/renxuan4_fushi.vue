  ...
  methods: {
    ...
    calculateBetCounts () {
      ...
      if (countArr.length === 4) {
        count += countArr[0].length * countArr[1].length * countArr[2].length * countArr[3].length
      }
      if (countArr.length === 5) {
        count += countArr[0].length * countArr[1].length * countArr[2].length * countArr[3].length
        count += countArr[0].length * countArr[1].length * countArr[3].length * countArr[4].length
        count += countArr[0].length * countArr[1].length * countArr[2].length * countArr[4].length
        count += countArr[0].length * countArr[2].length * countArr[3].length * countArr[4].length
        count += countArr[1].length * countArr[2].length * countArr[3].length * countArr[4].length
      }
