...
export default {
      ...
      numberList: [
        {
          ...
          numberList: [
            ...
            { isSelected: false, value: 18, label: 1 },
            { isSelected: false, value: 16, label: 2 },
            { isSelected: false, value: 14, label: 3 },
            { isSelected: false, value: 12, label: 4 },
            { isSelected: false, value: 10, label: 5 },
            { isSelected: false, value: 8, label: 6 },
            { isSelected: false, value: 6, label: 7 },
            { isSelected: false, value: 4, label: 8 },
            { isSelected: false, value: 2, label: 9 }
          ]
        }
      ],
  ...
  watch: {
    flagCount () {
      ...
      if (flag) {
        return this.getShoppingCarList(false, false, 0, undefined)
      }
