      ...
      numberList: [
        {
          ...
          numberList: [
            ...
            { isSelected: false, value: 3, label: 1 },
            { isSelected: false, value: 6, label: 2 },
            ...
            { isSelected: false, value: 36, label: 20 },
            { isSelected: false, value: 28, label: 21 },
            { isSelected: false, value: 21, label: 22 },
            { isSelected: false, value: 15, label: 23 },
            { isSelected: false, value: 10, label: 24 },
            { isSelected: false, value: 6, label: 25 },
            { isSelected: false, value: 3, label: 26 },
            { isSelected: false, value: 1, label: 27 }
          ]
        }
      ],
      ...
      this.numberList.map(item => {
        item.numberList.map(itemInner => {
          if (itemInner.isSelected) {
            choiceCount += itemInner.value
          }
        })
      })
      this.selectedCounts = choiceCount * allCount
