      ...
      numberList: [
        {
          ...
          numberList: [
            ...
            { isSelected: false, value: 8, label: 7 },
            { isSelected: false, value: 10, label: 8 },
            { isSelected: false, value: 11, label: 9 },
            { isSelected: false, value: 13, label: 10 },
            { isSelected: false, value: 14, label: 11 },
            { isSelected: false, value: 14, label: 12 },
            { isSelected: false, value: 15, label: 13 },
            { isSelected: false, value: 15, label: 14 },
            { isSelected: false, value: 14, label: 15 },
            { isSelected: false, value: 14, label: 16 },
            { isSelected: false, value: 13, label: 17 },
            { isSelected: false, value: 11, label: 18 },
            { isSelected: false, value: 10, label: 19 },
            { isSelected: false, value: 8, label: 20 },
            { isSelected: false, value: 6, label: 21 },
            { isSelected: false, value: 5, label: 22 },
            { isSelected: false, value: 4, label: 23 },
            { isSelected: false, value: 2, label: 24 },
            { isSelected: false, value: 2, label: 25 },
            { isSelected: false, value: 1, label: 26 }
          ]
        }
      ],
  ...
  methods: {
    ...
    calculateBetCounts () {
      ...
      this.numberList[0].numberList.map(item => {
        if (item.isSelected) {
          choiceCount += item.value
        }
      })
      count = choiceCount * typeCount
