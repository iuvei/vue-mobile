      ...
      <div class="top top_1">
        ...
        <div class="balls clear-fix">
                <span v-for="(ball, innerIndex) in item.numberList"
                      ...
                      :key="innerIndex"><a class="wuxing-btn" href="javascript:;">{{ball.label}}</a></span>
        </div>
      </div>
    </li>
  </ul>
      ...
      numberList: [
        {
          ...
          isSelectEven: false,
          numberList: [
            { isSelected: false, value: 0, label: '金(210-695)' },
            { isSelected: false, value: 1, label: '木(696-763)' },
            { isSelected: false, value: 2, label: '水(764-855)' },
            { isSelected: false, value: 3, label: '火(856-923)' },
            { isSelected: false, value: 4, label: '土(924-1410)' }
          ]
        }
      ],
...
<style scoped>
  ...
  .choice-number-list > li .top top_1 > .balls span{
    font-size: 14px;
  }
</style>
