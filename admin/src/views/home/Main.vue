            ...
            <el-col :span="6">
                <div class="card">
                    ...
                    <div class="value value-sum">
                        ...
                        <div class="sub" >游戏：<span>912,876,852.00</span></div>
                        <div class="sub">抽水：<span>912,876,852.00</span></div>
                        <p>今日总收益</p>
                    </div>
                </div>
            </el-col>
            <el-col :span="6">
                <div class="card">
                    <div class="symbol terques2">
                        <i class="fa iconfont icon-fenxiangzidongzhuanru"></i>
                    </div>
                    <div class="value">
            ...
            <el-col :span="6">
                <div class="card">
                    <div class="symbol terques8">
                        <i class="fa iconfont icon-fenxiangzidongzhuanchu"></i>
                    </div>
                    <div class="value">
...
.state-overview .terques1 {
    background: #6ccac9;
}

.state-overview .terques2 {
    background: #dc3545;
}

.state-overview .terques3 {
    background: #ffc107;
}

.state-overview .terques4 {
    background: #17a2b8;
}

.state-overview .terques5 {
    background: #6c757d;
}

.state-overview .terques6 {
    background: #6f42c1;
}

.state-overview .terques7 {
    background: #007bff;
}

.state-overview .terques8 {
    background: #a9d96c;
}
